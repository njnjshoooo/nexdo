  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // 過濾掉單純加入購物車但未結帳的訂單 (沒有 submissionId 且狀態為 UNPAID)
        orders = orders.filter(o => !(o.status === 'UNPAID' && !o.submissionId));
  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <PageMainTitle className="!text-3xl mb-2">後台儀表板</PageMainTitle>
