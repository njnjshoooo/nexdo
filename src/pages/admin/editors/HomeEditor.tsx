        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-200">
          <div className="space-y-4">
            <div className="space-y-1">
              <Label>眉標內容</Label>
              <input {...register(`content.home.blocks.${idx}.hero1.subtitle`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="例如：樂齡的居住服務" />
            </div>
            <div className="space-y-1">
              <Label>主標題內容</Label>
              <AdminMarkdownEditor {...register(`content.home.blocks.${idx}.hero1.title`)} rows={3} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[0, 1, 2, 3].map(i => (
                <div key={i} className="p-4 bg-stone-50 rounded-xl border border-stone-100 space-y-3">
                  ...
                  <input {...register(`content.home.blocks.${idx}.hero1.buttons.${i}.text`)} placeholder="按鈕文字" className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                  <input {...register(`content.home.blocks.${idx}.hero1.buttons.${i}.link`)} placeholder="跳轉連結" className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                </div>
              ))}
            </div>
            ...
            <div className="p-4 bg-primary/5 rounded-xl border border-primary/10 space-y-3">
              ...
              <AdminMarkdownEditor {...register(`content.home.blocks.${idx}.hero1.imageTestimonial.text`)} rows={2} placeholder="好評內容" className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
              <input {...register(`content.home.blocks.${idx}.hero1.imageTestimonial.author`)} placeholder="署名 (例如：台北市 林小姐)" className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
            </div>
    ...
    return (
      <>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-200 mb-6 space-y-4">
          <div className="space-y-1">
            <Label>區塊眉標</Label>
            <input {...register(`content.home.blocks.${servicesIdx}.services.subtitle`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="例如：我們提供" />
          </div>
          <div className="space-y-1">
            <Label>區塊主標題</Label>
            <input {...register(`content.home.blocks.${servicesIdx}.services.title`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="例如：從家庭環境到銀髮健康..." />
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <select 
                        ...
                        className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all"
                      >
                    ...
                    <div className="space-y-1">
                      <Label>主要服務標題</Label>
                      <input {...register(`content.home.blocks.${servicesIdx}.services.items.${index}.title`)} placeholder="服務顯示標題" className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                    </div>
                  </div>
                  
                  <div className="space-y-1">
                    <Label>服務描述</Label>
                    <AdminMarkdownEditor {...register(`content.home.blocks.${servicesIdx}.services.items.${index}.description`)} rows={3} placeholder="描述文字內容" className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                  </div>
                </div>
      ...
      <div className="bg-white p-10 rounded-[2.5rem] border border-stone-200 shadow-sm space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-2">
          <div className="space-y-2">
            <Label>區塊顯示標題</Label>
            <input {...register(`content.home.blocks.${moreServicesIdx}.moreServices.title`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="例如：我們還提供" />
          </div>
          <div className="space-y-2">
            <Label>區塊副標題</Label>
            <input {...register(`content.home.blocks.${moreServicesIdx}.moreServices.description`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="輸入副標題文字..." />
          </div>
        </div>
    ...
    return (
      <div className="bg-white p-10 rounded-[2.5rem] border border-stone-200 shadow-sm space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-2">
          <div className="space-y-2">
            <Label>區塊顯示標題</Label>
            <input {...register(`content.home.blocks.${processIdx}.process.title`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="輸入區塊標題..." />
          </div>
          <div className="space-y-2">
            <Label>區塊副標題</Label>
            <AdminMarkdownEditor {...register(`content.home.blocks.${processIdx}.process.description`)} rows={2} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="輸入副標題文字..." />
          </div>
        </div>
        ...
        <div className="px-2 space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            {[0, 1, 2, 3].map(i => (
              <input key={i} {...register(`content.home.blocks.${processIdx}.process.footerLabels.${i}`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder={`標籤 ${i + 1}`} />
            ))}
          </div>
        </div>
            ...
            <div key={field.id} className="p-10 bg-[#F9F9F9] rounded-[2rem] border border-stone-100 relative group transition-all">
              ...
              <div className="grid grid-cols-12 gap-8">
                <div className="col-span-8 space-y-2">
                  ...
                  <input {...register(`content.home.blocks.${processIdx}.process.steps.${index}.title`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                </div>
                <div className="col-span-4 space-y-2">
                  <Label>ICON 代碼</Label>
                  <input {...register(`content.home.blocks.${processIdx}.process.steps.${index}.icon`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                </div>
                <div className="col-span-12 space-y-2">
                  <Label>步驟詳細描述</Label>
                  <input {...register(`content.home.blocks.${processIdx}.process.steps.${index}.desc`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                </div>
              </div>
            </div>
          ))}
    ...
    return (
      <div className="bg-white p-10 rounded-[2.5rem] border border-stone-200 shadow-sm space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-2">
          <div className="space-y-2">
            <Label>區塊顯示標題</Label>
            <input {...register(`content.home.blocks.${testimonialIdx}.testimonials.title`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
          </div>
          <div className="space-y-2">
            <Label>區塊副標題</Label>
            <AdminMarkdownEditor {...register(`content.home.blocks.${testimonialIdx}.testimonials.description`)} rows={2} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="輸入副標題文字..." />
          </div>
        </div>
          ...
          {testimonialFields.map((field, index) => (
            <div key={field.id} className="p-10 bg-[#F9F9F9] rounded-[2rem] border border-stone-100 relative">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <Label>心得內容文字</Label>
                  <AdminMarkdownEditor {...register(`content.home.blocks.${testimonialIdx}.testimonials.items.${index}.content`)} rows={4} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label>客戶署名 / 稱呼</Label>
                    <input {...register(`content.home.blocks.${testimonialIdx}.testimonials.items.${index}.author`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" />
                  </div>
                  <div className="space-y-2">
                    <Label>職業 / 親屬關係</Label>
                    <input {...register(`content.home.blocks.${testimonialIdx}.testimonials.items.${index}.role`)} className="w-full border border-stone-200 bg-stone-50 p-3 rounded-xl text-sm focus:border-stone-900 focus:bg-white outline-none transition-all" placeholder="例如：上班族 / 父親78歲" />
                  </div>
                </div>
              </div>
            </div>
