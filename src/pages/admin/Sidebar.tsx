...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    } else if (path.startsWith('/admin/settings') || path.startsWith('/admin/seo-settings') || path.startsWith('/admin/navigation') || path.startsWith('/admin/emails') || path.startsWith('/admin/permissions') || path.startsWith('/admin/design-spec')) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'SEO 與搜尋設定', path: '/admin/seo-settings', permission: 'settings' },
