                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {update.photoUrl && (
                          <div>
                            ...
                            <img src={update.photoUrl || undefined} alt="服務完成照" className="rounded-lg w-full aspect-video object-cover border border-stone-200" />
                          </div>
                        )}
                        {update.receiptPhotoUrl && (
                          <div>
                            <p className="text-xs text-stone-500 mb-1">簽收單</p>
                            <img src={update.receiptPhotoUrl || undefined} alt="簽收單" className="rounded-lg w-full aspect-video object-cover border border-stone-200" />
                          </div>
                        )}
                      </div>
                    </div>
