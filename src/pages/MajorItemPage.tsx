    ...
    <div className="bg-[#FFF9F2] min-h-screen">
      ...
      <section className="relative min-h-[600px] flex items-center mt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={hero.backgroundImage || undefined} 
            alt={hero.title} 
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              {hero.mainButton?.isVisible && (
                <a 
                  href={hero.mainButton.value || '#services'} 
                  target={hero.mainButton.type === 'URL' && hero.mainButton.newTab ? '_blank' : '_self'}
                  rel={hero.mainButton.type === 'URL' && hero.mainButton.newTab ? 'noopener noreferrer' : undefined}
              ...
              {hero.secondaryButton?.isVisible && (
                <a 
                  href={hero.secondaryButton.value || '#cases'} 
                  target={hero.secondaryButton.type === 'URL' && hero.secondaryButton.newTab ? '_blank' : '_self'}
                  rel={hero.secondaryButton.type === 'URL' && hero.secondaryButton.newTab ? 'noopener noreferrer' : undefined}
