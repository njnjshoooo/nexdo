...
class ProductService {
  ...
  private toRow(product: Partial<Product>): any {
    ...
    if (product.checklist !== undefined) row.checklist = product.checklist;
    ...
    if (product.fixedConfig !== undefined) row.fixed_config = product.fixedConfig;
    if (product.quoteConfig !== undefined) row.quote_config = product.quoteConfig;
    if (product.internalFormConfig !== undefined) row.internal_form_config = product.internalFormConfig;
    if (product.externalLinkConfig !== undefined) row.external_link_config = product.externalLinkConfig;
