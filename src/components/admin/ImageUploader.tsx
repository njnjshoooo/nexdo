...
export default function ImageUploader({ value, onChange, className = '', placeholder = '點擊上傳或選擇圖片', aspectRatio = 'aspect-video' }: ImageUploaderProps) {
  ...
  return (
    <div className={`relative group ${className}`}>
      <div 
        ...
        className={`
          w-full ${aspectRatio} rounded-xl border-2 border-dashed 
